...
data class ChallengeCompleted (
    ...
    @SerialName("author_email") var author_email:String?= null,
    @SerialName("author_name") var author_name:String?= null,
    @SerialName("author_lastname") var author_lastname:String?= null,
    @SerialName("timestamp") var timestamp: Long? = null,
    @SerialName("challenge_id") var challenge_id: String? = null,
