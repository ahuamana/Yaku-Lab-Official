...
public abstract class Hilt_ProfileParentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ProfileParentFragment() {
    super();
  }

  Hilt_ProfileParentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfileParentFragment_GeneratedInjector) this.generatedComponent()).injectProfileParentFragment(UnsafeCasts.<ProfileParentFragment>unsafeCast(this));
    }
  }
